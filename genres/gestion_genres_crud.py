...
def genre_update_wtf():
    ...
    try:
        ...
        if request.method == "POST" and form_update.submit.data:
            ...
            prenom_apprenti_update = form_update.prenom_apprenti_update.data
            filiere_apprenti_update = form_update.filiere_apprenti_update.data
            ordonance_apprenti_update = form_update.ordonance_apprenti.data
            ...
            str_sql_id_genre = "SELECT id_apprennti, nom_apprenti, prenom_apprenti, filiere_apprenti, ordonance_apprenti FROM t_apprenti " \
            ...
            print("data_nom_apprenti ", data_nom_apprenti, " type ", type(data_nom_apprenti), " genre ",
                  data_nom_apprenti["intitule_genre"])
